        ...
        <>
            <Grid container spacing={4}>
                <Grid item xs={12} md={6} >
                    ...
                    <Typography variant='body1' component='p' textAlign='justify'>We help you with all the manufacturing process steps, so that you do not have to worry about a thing when it comes to your production. We provide you with a <b>100% completed product</b>, so that you can build up your brand and create a successful business.
                    </Typography>
