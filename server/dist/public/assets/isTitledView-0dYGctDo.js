...
`;function V({viewTitle:r,imageSrcSmallScreen:u,imageSrcLargeScreen:s}){const c=f(),l=W(c.breakpoints.down("sm"));return t.jsx(U,{sx:{backgroundImage:{xs:`url(${u})`,lg:`url(${s})`},backgroundSize:"contain",minHeight:{xs:"15vh",sm:"20vh",md:"20vh",lg:"26vh"}},children:t.jsx(m,{className:"overlay",height:"100%",children:t.jsx($,{sx:{height:"100%"},children:t.jsxs(v,{pl:{md:5},height:"100%",direction:"row",justifyContent:"space-between",alignItems:"center",children:[l?t.jsx(g,{variant:"h2",component:"h2",color:"custom.theme.almostWhite",children:r}):t.jsx(g,{variant:"h3",component:"h2",color:"custom.theme.almostWhite",children:r}),t.jsx(m,{component:"img",className:"logo",alt:"Stitch Sense Logo",src:P,height:{xs:70,md:100}})]})})})})}function G(r,{viewTitle:u,imageSrcSmallScreen:s,imageSrcLargeScreen:c}){return l=>t.jsxs(t.Fragment,{children:[t.jsx(V,{viewTitle:u,imageSrcSmallScreen:s,imageSrcLargeScreen:c}),t.jsx(v,{component:"main",flexGrow:1,sx:{background:`url(${R})`,backgroundRepeat:"no-repeat",backgroundSize:"contain",backgroundPosition:"top right"},children:t.jsx(m,{sx:{background:`url(${q})`,backgroundRepeat:"no-repeat",backgroundSize:"contain",backgroundPosition:"bottom left"},children:t.jsx(r,{...l})})})]})}export{G as i};
